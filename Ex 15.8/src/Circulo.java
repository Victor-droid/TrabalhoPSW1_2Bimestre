...
public class Circulo {
	...
	public int Raio(int x12, int y12, int x22, int y22) {
		double distanciad = Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2));
		int distancia = (int) Math.round(distanciad);
	...
	public double Area(int x12, int y12, int x22, int y22) {
		double distanciad = Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2));
		int distancia = (int) Math.round(distanciad);
		int raio = distancia/2;
	...
	public double Circunferencia(int x12, int y12, int x22, int y22) {
		double distanciad = Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2));
		int distancia = (int) Math.round(distanciad);
		int raio = distancia/2;
	...
	public void Circulo(Graphics graphics, int x12, int y12, int x22, int y22) {
